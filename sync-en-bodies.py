#!/usr/bin/env python3
"""Replace Chinese body content with English translations in blog-en files."""
...
en_bodies['ufo-filler-202605041800'] = r"""**March 1971. The Cold War was at its peak off the coast of Spain. The peaceful night at a radar base was shattered completely.**
...
en_bodies['ufo-filler-202605050200'] = r"""## Brazil's UFO Secret History: The Air Force's "Operation Saucer" and the Amazon Blood-Sucking Light Mystery
...
en_bodies['ufo-news-digest-202605041504'] = r"""> **UFO/UAP News — Automatically updated daily!** Today's highlights: Trump hints "interesting UFO files coming soon," multiple journalists and researchers continue pushing the disclosure process forward, and alien technology threat discussion sparks debate.
...
- [NUFORC Official Website](https://nuforc.org/)

---
*This article is generated automatically every hour based on public sources.*"""

# Write remaining bodies for the other articles
# ... (continuing with other articles)

print("English body templates defined for 3 articles so far.")
print("Need to write the Python replacement logic.")
